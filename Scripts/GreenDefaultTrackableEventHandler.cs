...
/// </summary>
public class GreenDefaultTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    public static int greentrackID;
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        if (mTrackableBehaviour.TrackableName.Equals("green"))
        {
          greentrackID = 1;
        }
